    ...
    return (
        <section className="w-full h-full flex flex-col items-center justify-center gap-8 pointer-events-auto-override transition-opacity duration-300">
            ...
            <div className="flex flex-col gap-4 w-full max-w-sm">
                <button className="metal-button font-headline-lg px-8 py-4 uppercase tracking-widest" onClick={() => onChangeState('CHAR_SELECT')}>Jogar</button>
                <button className="metal-button font-headline-lg px-8 py-4 uppercase tracking-widest" onClick={() => onChangeState('SKILL_TREE')}>Cofre Ancestral (Skills)</button>
            </div>
        </section>
    );
}
